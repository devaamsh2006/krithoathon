...
function PastEdition() {
  return (
    <div
      className="py-4 md:py-8 bg-gray-900 text-white"
        ...
        <div className="space-y-8 md:space-y-16">
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl shadow-xl hover:shadow-2xl transition duration-300 overflow-hidden">
            <div className="bg-gradient-to-r from-orange-500 to-yellow-500 py-4 md:py-6 text-center">
              <h2 className="text-2xl md:text-3xl font-bold text-white impo">
                Krithoathon 2.0
              </h2>
            ...
            <div className="p-4 md:p-8 flex flex-col md:flex-row gap-8">
              <div className="w-full md:w-1/2">
                ...
                <p className="text-sm md:text-base">
                  Krithoathon 2.0, an electrifying 24-hour hackathon held on
                  June 14-15, brought together 1000+ participants from over 9
                  states in a battle of innovation. The first round challenged
                  teams to submit their ideas through PPTs, while the second
                  round tested their coding skills, fostering creativity and
                  collaboration.
                </p>
                <div className="mt-6">
                  ...
                  <p className="text-sm md:text-base text-blue-200">
                    Top performers received several internship opportunities!
                  </p>
                </div>
              </div>
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl shadow-xl hover:shadow-2xl transition duration-300 overflow-hidden">
            ...
            <div className="p-4 md:p-8 flex flex-col md:flex-row gap-8">
              <div className="w-full md:w-1/2">
                ...
                <p className="text-sm md:text-base">
                  Krithoathon 1.0, the inaugural hackathon of our club, marked
                  the beginning of a remarkable legacy, bringing together bright
                  minds to innovate and collaborate. With intense challenges,
                  creative problem-solving, and an electrifying atmosphere, it
                  provided participants a platform to showcase their skills and
                ...
                <div className="mt-6">
                  ...
                  <p className="text-sm md:text-base text-gray-300 mt-2">
                    The first edition brought together talented students to
